...
declare function throwNotMarkdownFileWithTablesError(filePath: string): void;
...
export { throwEmptyText, throwEmptyTableInText, throwEmptyTableInFileError, throwEmptyFileError, throwNotFeatureFileError, throwNotMarkdownFileWithTablesError, throwNoEnoughScenarioOutlineInFileError, throwFailedToParseJsonFileError, throwJsonNotRepresentingListError };
